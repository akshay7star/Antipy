...
Play around with this visualizer to understand how pointers move when appending, prepending, or reversing a linked list. Notice how the `head`, `prev`, `curr`, and `next` pointers shift during the reverse operation!
