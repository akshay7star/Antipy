...
### Feature 3: Content Enrichment & Graphics (The "Anti-Learning" Polish) <!-- status: complete -->
...
- [x] F3-A2: Create Module 30: "Modern Python Tooling" (Type Hinting, Pip, Venv, Logging)
- [x] F3-A3: Expand Framework Modules (Flask/Django/FastAPI) - Add Routing, Templates, Auth lessons
- [x] F3-A4: Expand DB Module - Add Migrations, Raw SQL vs ORM, Relationships
